...
public class ChatService {
    ...
    public Map<String, Object> chat(String message) {
        if (message.isBlank()) {
            return Map.of("reply", "请输入您的问题");
        }

        if (!aiEnabled || aiEndpoint.isBlank()) {
            return Map.of("reply", getFallbackReply(message));
        }
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                if (choices != null && !choices.isEmpty()) {
                    ...
                    return Map.of("reply", msg.getOrDefault("content", "抱歉，我没理解您的问题"));
                }
            }
    ...
    public Map<String, Object> health() {
        return Map.of("aiEnabled", aiEnabled, "model", aiModel);
    }
