...
`,[O("scrollbar",`
 ...
 `,[O("base-loading",`
 color: var(--n-loading-color);
 `),O("base-selection-tags","min-height: var(--n-height);"),le("border, state-border",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
 ...
 `),O("base-selection-label","background-color: var(--n-color-active);"),O("base-selection-tags","background-color: var(--n-color-active);")])]),Z("disabled","cursor: not-allowed;",[le("arrow",`
 ...
 `),O("base-selection-label",`background-color: var(--n-color-active-${e});`),O("base-selection-tags",`background-color: var(--n-color-active-${e});`)]),Z("focus",[le("state-border",`
 ...
 display: inline-flex;
 padding: 0 7px 3px 0;
 `,[ie("&:last-child","padding-right: 0;"),O("tag",`
 font-size: 14px;
 max-width: 100%;
 `,[le("content",`
 line-height: 1.25;
...
`,[O("pagination-prefix",`
 ...
 `),ie("&.transition-disabled",[O("pagination-item","transition: none!important;")]),O("pagination-quick-jumper",`
 white-space: nowrap;
 display: flex;
...
`,[le("splitor",`
 ...
 `,[O("radio-button",{height:"var(--n-height)",lineHeight:"var(--n-height)"}),le("splitor",{height:"var(--n-height)"})]),O("radio-button",`
 vertical-align: bottom;
 outline: none;
 position: relative;
 user-select: none;
 ...
 display: flex;
 flex-direction: column;
 `),Z("flex-height",[ie(">",[O("data-table-wrapper",[ie(">",[O("data-table-base-table",`
 display: flex;
 flex-direction: column;
 flex-grow: 1;
 `,[ie(">",[O("data-table-base-table-body","flex-basis: 0;",[ie("&:last-child","flex-grow: 1;")])])])])])])]),ie(">",[O("data-table-loading-wrapper",`
 color: var(--n-loading-color);
 font-size: var(--n-loading-size);
 position: absolute;
 left: 50%;
 ...
 align-items: center;
 justify-content: center;
 `,[sn({originalTransform:"translateX(-50%) translateY(-50%)"})])]),O("data-table-expand-placeholder",`
 margin-right: 8px;
 display: inline-block;
 width: 16px;
 height: 1px;
 ...
 transition: color .3s var(--n-bezier);
 `,[Z("expanded",[O("icon","transform: rotate(90deg);",[wt({originalTransform:"rotate(90deg)"})]),O("base-icon","transform: rotate(90deg);",[wt({originalTransform:"rotate(90deg)"})])]),O("base-loading",`
 color: var(--n-loading-color);
 transition: color .3s var(--n-bezier);
 position: absolute;
 left: 0;
 ...
 box-sizing: border-box;
 `),Z("striped","background-color: var(--n-merged-td-color-striped);",[O("data-table-td","background-color: var(--n-merged-td-color-striped);")]),ot("summary",[ie("&:hover","background-color: var(--n-merged-td-color-hover);",[ie(">",[O("data-table-td","background-color: var(--n-merged-td-color-hover);")])])])]),O("data-table-th",`
 padding: var(--n-th-padding);
 position: relative;
 text-align: start;
 box-sizing: border-box;
 ...
 `,[ie("&::after, &::before",`
 bottom: 0 !important;
 `)])]),ot("single-line",[O("data-table-th",`
 ...
 overflow: hidden;
 `)]),O("data-table-base-table",[Z("transition-disabled",[O("data-table-th",[ie("&::after, &::before","transition: none;")]),O("data-table-td",[ie("&::after, &::before","transition: none;")])])]),Z("bottom-bordered",[O("data-table-td",[Z("last-row",`
 border-bottom: 1px solid var(--n-merged-border-color);
 `)])]),O("data-table-table",`
