  ...
  routes: [
    ...
    { path: '/reset-password', name: 'ResetPassword', component: ResetPasswordView, meta: { title: 'nav.resetPassword' } },
    {
      ...
      children: [
        ...
        { path: 'groupbuy', name: 'GroupBuy', component: GroupBuyView, meta: { title: 'nav.groupbuy' } },
        { path: 'flashsale', name: 'FlashSale', component: FlashSaleView, meta: { title: 'nav.flashsale' } },
        { path: 'aftersale', name: 'AfterSale', component: AfterSaleView, meta: { title: 'nav.aftersale' } },
        { path: 'articles', name: 'Articles', component: ArticleView, meta: { title: 'nav.articles' } },
        { path: 'notifications', name: 'Notifications', component: NotificationView, meta: { title: 'nav.notifications' } },
        { path: 'giftcards', name: 'GiftCards', component: GiftCardView, meta: { title: 'nav.giftcards' } },
        ...
        { path: 'feedback', name: 'Feedback', component: FeedbackView, meta: { title: 'nav.feedback' } },
        ...
        { path: 'messages', name: 'Messages', component: MessageView, meta: { title: 'nav.messages' } },
        { path: 'ip-blacklist', name: 'IpBlacklist', component: IpBlacklistView, meta: { title: 'nav.ipBlacklist' } },
        { path: 'approval', name: 'Approval', component: ApprovalView, meta: { title: 'nav.approval' } },
        { path: 'register-approval', name: 'RegisterApproval', component: RegisterApprovalView, meta: { title: 'nav.registerApproval' } },
        { path: 'oauth2-clients', name: 'OAuth2Clients', component: OAuth2ClientView, meta: { title: 'nav.oauth2Client' } },
        ...
        { path: 'banners', name: 'Banners', component: BannerView, meta: { title: 'nav.banners' } },
        ...
        { path: 'shipments', name: 'Shipments', component: ShipmentView, meta: { title: 'nav.shipments' } },
        ...
        { path: 'coupons', name: 'Coupons', component: CouponView, meta: { title: 'nav.coupons' } },
        ...
        { path: 'activity-logs', name: 'ActivityLogs', component: ActivityLogView, meta: { title: 'nav.activityLogs' } },
    ...
    { path: '/oauth2/consent', name: 'Consent', component: ConsentView, meta: { title: 'nav.consent' } },
    { path: '/oauth2/callback', name: 'OAuth2Callback', component: OAuth2CallbackView, meta: { title: 'nav.thirdPartyLogin' } },
