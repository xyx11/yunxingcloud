...
import { fetchOAuth2Clients, createOAuth2Client, deleteOAuth2Client } from '@/api/oauth2client'
...
async function delClient(id: string) { await deleteOAuth2Client(Number(id)); loadClients() }
