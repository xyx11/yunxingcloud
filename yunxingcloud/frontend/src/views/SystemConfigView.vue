...
const columns: DataTableColumns<any> = [
  ...
  { title: '操作', key: 'act', width: 80, render(r: any) { return h(NButton, { size: 'tiny', onClick: () => { form.value = { key: r.key, value: r.value || '', description: r.description || '' }; showModal.value = true } }, { default: () => '编辑' }) } },
]
