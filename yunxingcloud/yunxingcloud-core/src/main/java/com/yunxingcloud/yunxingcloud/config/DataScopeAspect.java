...
public class DataScopeAspect {
    ...
    private String buildScope(String username, DataScope ds) {
        ...
        Long deptId = null;
        try { deptId = jdbc.queryForObject("SELECT department_id FROM users WHERE username=?", Long.class, username); } catch (Exception ignored) { log.warn("Operation failed: {}", ignored.getMessage()); }
