...
public class SystemService {
    ...
    public SystemService(CacheManager cacheManager, TokenStore tokenStore,
    ...
    public Map<String, Object> getCacheInfo() {
        ...
        return Map.of("cacheNames", names, "details", details);
    }

    public Map<String, Object> addSnapshot() {
        var mem = ManagementFactory.getMemoryMXBean();
        var osBean = ManagementFactory.getOperatingSystemMXBean();
    ...
    public Map<String, Object> getSessions() {
        return Map.of("count", tokenStore.count(), "sessions", tokenStore.activeSessions());
    }

    public Map<String, Object> revokeSession(String username) {
        if (username == null) {
            return Map.of("success", false, "message", i18n.msg("system.username_required"));
        }
        tokenStore.revokeByUser(username);
        return Map.of("success", true, "message", i18n.msg("system.revoke_success", username));
    }
    ...
    public Map<String, Object> benchmark() {
        ...
        try {
            ...
            r.put("db_ms", System.currentTimeMillis() - start);
        } catch (Exception e) {
            r.put("db_ms", -1);
        }
    ...
    @Transactional
    public Map<String, Object> updateAnnouncement(String message) {
        ...
        jdbcTemplate.update("INSERT INTO sys_config (name, config_key, config_value, config_type) VALUES (?,?,?,?)",
                "系统公告", "sys.announcement", message, "Y");
        featureFlags.refresh();
        return Map.of("success", true, "message", i18n.msg("system.announcement_updated"));
    }
    ...
    public Map<String, Object> clearCache() {
        ...
        return Map.of("success", true, "message", i18n.msg("system.cache_cleared"));
    }
