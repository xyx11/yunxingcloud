...
<template>
  <div style="max-width:420px;margin:40px auto">
    <div style="background:#fff;border-radius:12px;padding:40px;box-shadow:0 2px 8px rgba(0,0,0,.06)">
      <h2 style="text-align:center;font-size:22px;margin-bottom:8px">用户注册</h2>
      <p style="text-align:center;color:#999;font-size:13px;margin-bottom:24px">注册 YXCLOUD 商城账号</p>
      ...
      <button @click="doRegister" style="width:100%;height:44px;background:#e4393c;color:#fff;border:none;border-radius:8px;font-size:16px;cursor:pointer;font-weight:600">注册</button>
