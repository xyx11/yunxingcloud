...
export const regionData: Record<string, Record<string, string[]>> = {
  ...
  '辽宁省': {
    ...
    '阜新市': ['海州区','新邱区','太平区','细河区','清河门区','阜新蒙古族自治县','彰武县'],
  ...
  '湖南省': {
    ...
    '永州市': ['零陵区','冷水滩区','东安县','双牌县','道县','江永县','宁远县','新田县','蓝山县','祁阳市'],
  ...
  '广东省': {
    ...
    '东莞市': ['东城街道','南城街道','莞城街道','万江街道','虎门镇','长安镇','厚街镇','常平镇','塘厦镇','大朗镇','寮步镇','凤岗镇','清溪镇','大岭山镇','石碣镇','石龙镇','茶山镇','企石镇','桥头镇','东坑镇','横沥镇','谢岗镇','樟木头镇','黄江镇','石排镇','中堂镇','望牛墩镇','麻涌镇','洪梅镇','道滘镇','高埗镇','沙田镇'],
  ...
  '广西壮族自治区': {
    ...
    '梧州市': ['万秀区','龙圩区','长洲区','苍梧县','藤县','蒙山县','岑溪市'],
  ...
  '四川省': {
    '成都市': ['锦江区','青羊区','金牛区','武侯区','成华区','龙泉驿区','青白江区','新都区','双流区','温江区','郫都区','新津区','金堂县','大邑县','蒲江县','都江堰市','彭州市','崇州市','简阳市','邛崃市'],
    '自贡市': ['自流井区','贡井区','大安区','沿滩区','荣县','富顺县'],
    '攀枝花市': ['东区','西区','仁和区','米易县','盐边县'],
    '泸州市': ['江阳区','纳溪区','龙马潭区','泸县','合江县','叙永县','古蔺县'],
    '德阳市': ['旌阳区','罗江区','中江县','广汉市','绵竹市','什邡市'],
  ...
  '云南省': {
    ...
    '红河哈尼族彝族自治州': ['蒙自市','个旧市','开远市','弥勒市','建水县','石屏县','泸西县','元阳县','红河县','金平苗族瑶族傣族自治县','绿春县','屏边苗族自治县','河口瑶族自治县'],
  ...
  '澳门特别行政区': { '澳门': ['花地玛堂区','圣安多尼堂区','大堂区','望德堂区','风顺堂区','嘉模堂区','圣方济各堂区'] },
  '台湾省': {
    '台北市': ['中正区','大同区','中山区','松山区','大安区','万华区','信义区','士林区','北投区','内湖区','南港区','文山区'],
    '新北市': ['板桥区','新庄区','中和区','永和区','土城区','树林区','三峡区','莺歌区','三重区','芦洲区','五股区','泰山区','林口区','淡水区','汐止区','瑞芳区','八里区','深坑区','石碇区','坪林区','三芝区','金山区','万里区'],
    '高雄市': ['楠梓区','左营区','鼓山区','三民区','盐埕区','前金区','新兴区','苓雅区','前镇区','旗津区','小港区','凤山区','冈山区','路竹区','桥头区','梓官区','弥陀区','永安区','湖内区','大社区','仁武区','大树区','燕巢区','田寮区','阿莲区','美浓区','旗山区','杉林区','甲仙区','六龟区'],
    '台中市': ['中区','东区','南区','西区','北区','北屯区','西屯区','南屯区','太平区','大里区','雾峰区','乌日区','丰原区','后里区','神冈区','潭子区','大雅区','新社区','石冈区','外埔区','大甲区','大安区','清水区','梧栖区','沙鹿区','大肚区','龙井区'],
    '台南市': ['中西区','东区','南区','北区','安平区','安南区','永康区','归仁区','新化区','善化区','新市区','仁德区'],
...
export function cityList(province: string): string[] {
  return province && regionData[province] ? Object.keys(regionData[province]) : []
}

export function districtList(province: string, city: string): string[] {
